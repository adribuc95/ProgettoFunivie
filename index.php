...
$numero_prodotti=$ordine->countProduct($_SESSION["ID_ordine"]);
$tipologia_tessere = $ordine->getTessere_StessoOrdine($_SESSION["ID_ordine"]);
}
else {
    $numero_prodotti = 0;
...
<html>
    ...
    //funzione che va a controllare che sia stata inserita una foto (o checked 'dagli anni scorsi') e se ritorna false blocca il submit.
    function checkFoto() {
...
<body>
    ...
    <form method="post" action="" name="dati_utente">
        <center>
        <ul class="price2">
            <!--per future implementazioni di più prodotti venduti
                onclick='if(document.getElementById("tessere").style.display == "none") { mostra("tessere"); } else {nascondi("tessere"); }'-->
                
            <li class="header2 main">Seleziona il prodotto:</li> <a href="#openModal2"><i class="fa fa-info-circle" style="font-size:20px"></i></a>
                </ul>
        </center>
               
        <br>
        <center>
                    <!--MODAL differenze SKIRAMA/CAMPIGLIO-->
     ...
     <!--FINE MODAL-->
        ...
        <div class="TESSERE" width='100%'> <!--style='display: none;' per future implementazioni di più prodotti-->
            ...
            <div class="column1" style="text-align: center">
                <div>
                    <img src="Pagina_iniziale/Skirama.jpg" alt="Skirama" class="immagine" style="width: 250px;">
                </div>
...
<!--SECONDO CONTAINER, contiene il FORM per la raccolta dati e la FOTO. su 2 colonne se schermo grande, altrimenti 1 colonna, FOTO su 1 colonna.-->
	...
	<fieldset>
            <label>Fax</label>
            <input class="input" name="fax" id="fax" type="tel" value="<?php if (isset($_SESSION['fax'])&& $_SESSION['fax'] <> '') {    echo $_SESSION['fax'];}?>"/>
	</fieldset>
	<fieldset>
            <label>Sito Web</label>
            <input class="input" name="sito" id="sito" type="text" placeholder="www.sito.com" value="<?php if (isset($_SESSION['sito'])&& $_SESSION['sito'] <> '') {    echo $_SESSION['sito'];}?>"/>
	</fieldset>
	<fieldset>
...
Per tutti i dettagli sulle coperture offerte, e per consultare il Fascicolo Informativo del prodotto AIG sNOw Problem – Formula stagionale clicca <a href="https://www.funiviecampiglio.it/43-estate-inverno/287-assicurazione" target="_blank">qui</a> </p></div>
            ...
            <input class="input" name="CF" id="CF" type="text" pattern='[a-zA-Z]{6}[0-9]{2}[a-zA-Z][0-9]{2}[a-zA-Z][0-9]{3}[a-zA-Z]' placeholder="" style='width: 70%; margin-top: 5px;'/>
                ...
                <!-- div per evitare errore di impaginazione-->
                <div style='color:white;' id='impaginazione'>we</div>
    ...
    <div class="column3">
        ...
        <div>
        <button type="button" class="bottone" id="upload2" style="display:none; margin-top: 10px;"> Salva <i class="fa fa-upload" style="font-size:16px"></i></button>
        <br> 
        <span id="uploading2" style="display:none; background-color: gold"> <b> Attendi . . . </b> </span>
        
        </div>
        </div>
        <span id="no-uploading" style="background-color: red"> <b> Immagine mancante </b> </span>
        <span id="uploading3" style="display:none; background-color: gold"> <b> Attendi . . . </b> </span>
        <span id="uploaded"  style="display:none; background-color: #00dd00"> <b> Foto salvata! <i class="fa fa-check" style="font-size:16px"></i></b></span>
...
<div>
    ...
    <button type="button" id="upload" class="bottone" style="display:none; margin-top: 10px;"> Salva <i class="fa fa-upload" style="font-size:16px"></i></button>
    <br> 
